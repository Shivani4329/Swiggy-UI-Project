...
export default function Card({ image, offer ,title,rating,minTime,maxTime,name,place}) {
  return (
    <div className=' w-full md:w-[273px] shrink-0  mb-5'>
      <div className=' group h-[182px] rounded-[15px] overflow-hidden relative'>
        <img className='group-hover:scale-110 object-cover w-full h-full' src={`http://localhost:3001/${image}`} alt='' />
